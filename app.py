...
def main():
    ...
    pages = [
        ...
        st.Page(ad_product_type_page, title="Beta Ad product type", icon="🧾", url_path="ad-product-type"),
        st.Page(placement_analysis_page,title="Beta Placement Analysis",icon="📍",url_path="placement-analysis"),
